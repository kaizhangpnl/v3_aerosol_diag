...
param.test_name = '20231209.v3.LR.piControl-spinup.chrysalis'
param.short_test_name = '20231209.v3.LR.piControl-spinup.chrysalis'

# Reference
param.reference_data_path = 'climo_ref'
param.ref_name = '20231117.v3b02.piControl.chrysalis'
param.short_ref_name = '20231117.v3b02.piControl.chrysalis'

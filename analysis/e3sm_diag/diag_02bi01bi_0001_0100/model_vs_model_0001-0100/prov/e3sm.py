...
short_name = '20230622.v3alpha02.piControl.chrysalis'
test_ts = ''
start_yr = int('0001')
end_yr = int('0100')
...
param.test_name = '20230622.v3alpha02.piControl.chrysalis'
param.short_test_name = '20230622.v3alpha02.piControl.chrysalis'

# Reference
param.reference_data_path = 'climo_ref'
param.ref_name = '20230616.v3alpha01.piControl.chrysalis'
param.short_ref_name = '20230616.v3alpha01.piControl.chrysalis'

...
short_name = '20231117.v3b02.piControl.chrysalis'
test_ts = ''
start_yr = int('0001')
end_yr = int('0100')
...
param.test_name = '20231117.v3b02.piControl.chrysalis'
param.short_test_name = '20231117.v3b02.piControl.chrysalis'

# Reference
param.reference_data_path = 'climo_ref'
param.ref_name = '20231105.v3b01.piControl.chrysalis'
param.short_ref_name = '20231105.v3b01.piControl.chrysalis'

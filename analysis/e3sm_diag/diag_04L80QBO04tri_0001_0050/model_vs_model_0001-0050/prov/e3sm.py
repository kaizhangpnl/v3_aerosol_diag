...
short_name = '20231023.v3alpha04-L80QBO.trigrid.piControl.chrysalis'
test_ts = ''
start_yr = int('0001')
end_yr = int('0050')
...
param.test_name = '20231023.v3alpha04-L80QBO.trigrid.piControl.chrysalis'
param.short_test_name = '20231023.v3alpha04-L80QBO.trigrid.piControl.chrysalis'

# Reference
param.reference_data_path = 'climo_ref'
param.ref_name = '20230924.v3alpha04_trigrid.piControl.chrysalis'
param.short_ref_name = '20230924.v3alpha04_trigrid.piControl.chrysalis'
...
# Output dir
param.results_dir = 'model_vs_model_0001-0050'

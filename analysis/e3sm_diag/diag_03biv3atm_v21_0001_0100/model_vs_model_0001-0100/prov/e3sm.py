...
short_name = '20230914.v3alpha03_bigrid.piControl.chrysalis'
test_ts = ''
start_yr = int('0001')
end_yr = int('0100')
...
param.test_name = '20230914.v3alpha03_bigrid.piControl.chrysalis'
param.short_test_name = '20230914.v3alpha03_bigrid.piControl.chrysalis'

# Reference
param.reference_data_path = 'climo_ref'
param.ref_name = '20230224.v3atm_v21.piControl.chrysalis'
param.short_ref_name = '20230224.v3atm_v21.piControl.chrysalis'

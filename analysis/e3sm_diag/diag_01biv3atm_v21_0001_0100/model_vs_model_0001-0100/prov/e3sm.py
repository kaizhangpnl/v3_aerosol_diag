...
short_name = '20230616.v3alpha01.piControl.chrysalis'
test_ts = ''
start_yr = int('0001')
end_yr = int('0100')
...
param.test_name = '20230616.v3alpha01.piControl.chrysalis'
param.short_test_name = '20230616.v3alpha01.piControl.chrysalis'
